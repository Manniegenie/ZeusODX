...
export default function EthDepositScreen() {
  ...
  const handleGetEthereumAddress = async (): Promise<void> => {
    try {
      ...
      if (result.success) {
        ...
        showErrorMessage(result.error || 'Failed to get ETH deposit address');
      }
    } catch (error) {
  ...
  const isLoading = isAddressLoading('ETH', 'ETH') || supportedLoading;
  const addressError = getAddressError('ETH', 'ETH');
          ...
          <View style={styles.headerSection}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerRight}>
                <HintBulb
                  title="Deposit tip"
                  hint="Only send Ethereum (ETH) to this address on the Ethereum network. Sending any other asset or using a different network may result in permanent loss."
                />
              </View>
            </View>
          </View>
            ...
            <View style={styles.qrContainer}>
              {isLoading ? (
                <View style={styles.loadingContainer}>
                  ...
                  <Text style={styles.loadingText}>Loading ETH address...</Text>
                </View>
              ) : qrCodeData ? (
