...
export default function AvaxBscDepositScreen() {
  ...
  const handleGetAVAXAddress = async (): Promise<void> => {
    try {
      ...
      if (result.success) {
        ...
        showErrorMessage(result.error || 'Failed to get AVAX deposit address');
      }
    } catch (error) {
  ...
  const copyToClipboard = async (): Promise<void> => {
    if (!depositData?.address) {
      showErrorMessage('AVAX wallet address is not yet available');
      return;
    }
    try {
  ...
  const isLoading = isAddressLoading('AVAX', 'BSC') || supportedLoading;
  const addressError = getAddressError('AVAX', 'BSC');
        ...
        >
          <View style={styles.headerSection}>
            ...
            <View style={styles.headerGroup}>
              <Text style={styles.headerTitle}>Deposit AVAX</Text>
            ...
            <View style={styles.qrContainer}>
              {isLoading ? (
                <View style={styles.loadingContainer}>
                  ...
                  <Text style={styles.loadingText}>Loading AVAX address...</Text>
                </View>
              ) : qrCodeData ? (
