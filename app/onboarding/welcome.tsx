      ...
      <View style={styles.content}>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.iconContainer}>
            <Image 
              source={require('../../assets/images/Group.png')} // Replace with your icon filename
              style={styles.customIcon}
              resizeMode="contain"
            />
          </View>

          <Text style={styles.title}>Crypto to Cash Instantly.</Text>
          <Text style={styles.subtitle}>Fast. Simple. No delays.</Text>
