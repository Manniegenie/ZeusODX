...
const makeStyles = (colors: AppColors) => StyleSheet.create({
  ...
  otpInput: { width: 45, height: 48, borderRadius: 8, borderWidth: 1, borderColor: '#E0E0E0', backgroundColor: '#E0DEFF', fontSize: 16, fontFamily: Typography.medium, color: colors.text },
