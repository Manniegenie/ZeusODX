...
const utilitiesIcon = require('../../components/icons/sell-icon.png'); // Reusing the sell icon for utilities
const swapIcon = require('../../components/icons/swap-icon.png');
const portfolioBackground = require('../../assets/images/portfolio-bgg.jpg');
...
export default function PortfolioSection({ 
  ...
  { id: 'swap', title: 'Swap', icon: utilitiesIcon, route: '/user/Swap' },
];
  ...
  // Interpolate progressFill width
  ...
  // Interpolate progressText translateX
  ...
  // Interpolate progressText opacity
  ...
  const shouldShowSetupBanner = completionPercentage < 100;
...
const styles = StyleSheet.create({
  ...
  progressText: {
    ...
    width: '100%',
    textAlign: 'center',
    lineHeight: 14, // Match progressBar height for vertical centering
  },
});