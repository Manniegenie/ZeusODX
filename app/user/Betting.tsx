...
const makeStyles = (colors: AppColors) => StyleSheet.create({
  ...
  providerSelector: { backgroundColor: colors.card, borderRadius: 8, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 16, paddingVertical: 16, flexDirection: 'row', alignItems: 'center' },
  providerLogo: { width: 28, height: 28, marginRight: 12, borderRadius: 14, backgroundColor: colors.inputBg },
  ...
  inputContainer: { flex: 1, backgroundColor: colors.card, borderRadius: 8, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 16, paddingVertical: 12 },
  input: { color: colors.text, fontFamily: Typography.regular || 'System', fontSize: 16, fontWeight: '400', paddingVertical: 4 },
  uneditableInput: { backgroundColor: colors.inputBg, color: colors.textSecondary },
  proceedButton: { backgroundColor: colors.primary, borderRadius: 6, paddingHorizontal: 12, paddingVertical: 12, justifyContent: 'center', alignItems: 'center', minWidth: 70 },
  ...
  amountButton: { width: '31%', backgroundColor: colors.card, borderRadius: 8, borderWidth: 1, borderColor: colors.border, paddingVertical: 16, justifyContent: 'center', alignItems: 'center' },
  amountButtonSelected: { borderColor: colors.primary, backgroundColor: colors.iconBg },
  amountButtonText: { color: colors.text, fontFamily: Typography.regular || 'System', fontSize: 14, fontWeight: '400' },
  amountButtonTextSelected: { color: colors.primary, fontWeight: '500' },
  ...
  continueButton: { backgroundColor: colors.primary, borderRadius: 8, paddingVertical: 16, justifyContent: 'center', alignItems: 'center', elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
