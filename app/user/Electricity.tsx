...
const ElectricityScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {(loading || isProcessing || customerLoading) && <Loading />}
    </View>
  );
};
...
const makeStyles = (colors: AppColors) => StyleSheet.create({
  ...
  safeArea: { flex: 1 },
  scrollView: { flex: 1 },
  historyLink: { color: colors.primary, fontFamily: Typography.medium || 'System', fontSize: 14, fontWeight: '500' },
  ...
  paymentTypeButton: {
    flex: 1, backgroundColor: colors.card, borderRadius: 8, borderWidth: 1, borderColor: colors.border,
    paddingHorizontal: 16, paddingVertical: 12, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', position: 'relative',
  },
  paymentTypeButtonSelected: { borderColor: colors.primary, backgroundColor: colors.iconBg },
  paymentTypeText: { color: colors.text, fontFamily: Typography.regular || 'System', fontSize: 14, fontWeight: '400' },
  paymentTypeTextSelected: { color: colors.primary, fontWeight: '500' },
  checkmark: {
    position: 'absolute', right: 12, top: 8, width: 20, height: 20, borderRadius: 10, backgroundColor: colors.primary,
  ...
  amountButton: {
    width: '31%', backgroundColor: colors.card, borderRadius: 8, borderWidth: 1, borderColor: colors.border,
  ...
  continueButton: {
    backgroundColor: colors.primary, borderRadius: 8, paddingVertical: 16, justifyContent: 'center', alignItems: 'center',
