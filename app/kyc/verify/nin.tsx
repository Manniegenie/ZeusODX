...
/**
 * UI CONSTANTS
 * Adjusted minY to 0.25 to force the user to hold the phone 
 * perfectly upright, aligning the lens with the face.
 */
...
export default function NINVerify() {
  ...
  const { isVerifying, isValidating, submitBiometricVerification, validateBiometricData, validateNIN, formatIdNumber } = useBiometricVerification();
      ...
      <View style={styles.section}>
        ...
        <View style={styles.inputContainer}>
          <TextInput
            ...
            style={[styles.input, !isValidFormat && nin.length > 0 && styles.inputError]}
          />
          {!isValidFormat && nin.length > 0 && <Text style={styles.errorText}>{validation?.message}</Text>}
