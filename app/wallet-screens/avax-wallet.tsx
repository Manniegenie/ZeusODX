// app/user/AvaxWalletScreen.tsx - Updated to match SolanaWalletScreen styling
...
const AvaxWalletScreen = ({ onQuickActionPress, onSeeMorePress }) => {
  ...
  const {
    ...
    hasTransactions,
    refreshTransactions
  } = useHistory('AVAX', { defaultPageSize: 5 });
  ...
  const displayAvaxBalance = formattedAvaxBalance || '0.00000000';
