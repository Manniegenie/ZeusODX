...
const BitcoinWalletScreen: React.FC<BitcoinWalletScreenProps> = ({
  onQuickActionPress,
  onSeeMorePress
}) => {
  ...
  const onRefresh = useCallback(async () => {
    try {
      console.log('🔄 Refreshing BTC wallet data...');
      await refreshBalances();
      console.log('✅ BTC wallet refresh completed');
    } catch (error) {
      console.error('❌ Error refreshing BTC wallet:', error);
    }
  }, [refreshBalances]);
  ...
  const displayUsdBalance = formattedBtcBalanceUSD || '$0.00';
            ...
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGroup}>
                <View style={styles.bitcoinIcon}>
                  <Image source={btcIcon} style={styles.bitcoinIconImage} />
                </View>
          ...
          <View style={styles.balanceSection}>
            <View style={styles.balanceCard}>
              {loading && !btcBalance ? (
                ...
                <>
                  <Text style={styles.balanceAmount}>BTC {displayBtcBalance}</Text>
