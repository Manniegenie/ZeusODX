// app/user/SolanaWalletScreen.tsx
...
const SolanaWalletScreen = ({ onQuickActionPress, onSeeMorePress }) => {
  ...
  const handleTransferMethodSelect = (method: TransferMethod) => {
    const token = { id: 'sol', name: 'Solana', symbol: 'SOL' };
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        ...
                        // Ensure app/history/TransactionReceipt.tsx exists and renders the Receipt screen
                        router.push({
