...
const NGNZWalletScreen = ({ onQuickActionPress, onSeeMorePress }) => {
  ...
  const displayNaira = formattedNgnzBalance || '0.00';
          ...
          <View style={styles.headerSection}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.headerGroup}>
                <View style={styles.ngnzIcon}>
                  <Image source={ngnzIcon} style={styles.ngnzIconImage} />
                </View>
          ...
          <View style={styles.balanceSection}>
            <View style={styles.balanceCard}>
              {loading && !ngnzBalance ? (
                ...
                <>
                  <Text style={styles.balanceAmount}>NGNZ {displayNaira}</Text>
