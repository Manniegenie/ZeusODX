...
export default function TransactionReceiptScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        {/* Amount stays centered above the table */}
        ...
        {/* Centered status under the amount */}
        ...
        {/* Keep the table (details card) in the middle as before */}
...
const styles = StyleSheet.create({
  ...
  // Keep the details card in the middle (original placement)
  detailsCard: {
    width: '100%',
