...
router.post('/crypto-fee', async (req, res) => {
  try {
    ...
    const normalizedNetwork = normalizeSymbol(network);
...
// DELETE /crypto-fee - Delete specific crypto fee by currency and network
router.delete('/crypto-fee', async (req, res) => {
  try {
